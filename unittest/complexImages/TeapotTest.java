...
class TeapotTest {
    ...
    private final Camera.Builder camera = Camera.getBuilder()
            ...
            .setVpDistance(1000)
            .setVpSize(200,200)
            .setImageWriter(imageWriter).setAntiAliasing(true).adaptiveSuperSampling(true).rootNumberOfRays(9);
    ...
    public void teapot() {
        ...
        camera.setRayTracer(new SimpleRayTracer(scene)).build().renderImage().setMultithreading(6).printGrid(50, new Color(YELLOW)).writeToImage();
    }
