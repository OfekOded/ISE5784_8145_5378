...
class PlaneTest {
    ...
    void testFindIntersections() {
        ...
        //TC14: The ray is perpendicular and starts at the plane
        ...
        //TC15: The ray is perpendicular and starts after the plane
        ...
        //TC16: The ray starts in a plane (not perpendicular)
    ...
    void testFindMaxDistanceIntersections(){
        // ============ Equivalence Partitions Tests ==============
        //TC01: The distance between the intersection point and the plane is less than maxDistance
        final var result1 = plane.findIntersections(new Ray(new Point(0, 0, 4), new Vector(-4, 0, -4)),10000000);
        assertEquals(1, result1.size(), "ERROR: when the ray cuts the plane and the distance between the intersection point and the plane is less than maxDistance");
        //TC02: The distance between the intersection point and the plane is bigger than maxDistance
        assertNull(plane.findIntersections(new Ray(new Point(0, 0, 4), new Vector(-4, 0, -4)),0.5), "ERROR: when the ray cuts the plane and the distance between the intersection point and the plane is bigger than maxDistance");
        // =============== Boundary Values Tests ==================
        // TC11: The distance between the intersection point and the plane is maxDistance
        final var result2 = plane.findIntersections(new Ray(new Point(0, 0, 4), new Vector(-4, 0, -4)),4.242);
        assertEquals(1, result1.size(), "ERROR: when the ray cuts the plane and the distance between the intersection point and the plane is maxDistance");
