...
class CylinderTest {
    ...
    void getNormal() {
        ...
        assertEquals(new Vector(0, 0, 1), testCylinder.getNormal(new Point(0, 0, 8)),
                "Incorrect normal vector at the base of the cylinder when the point merges with the axis of the cylinder");
    }
}
