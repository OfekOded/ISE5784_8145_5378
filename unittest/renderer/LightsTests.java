...
public class LightsTests {
    ...
    public void sphereAllLights() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new DirectionalLight(new Color(RED), new Vector(1, 0,0)));
        scene1.lights.add(new PointLight(new Color(ORANGE), new Point(0, 70, 0)).setkL(0.001).setkQ(0.0002));
        scene1.lights.add(new SpotLight(new Color(PINK), new Point(70, -70, 0), new Vector(-70, 70, -50))
                .setkL(0.001).setkQ(0.0001));
    ...
    public void trianglesAllLights() {
        scene2.geometries.add(triangle1, triangle2);
        scene2.lights.add(new DirectionalLight(new Color(PINK), new Vector(-1, 1,0)));
       scene2.lights.add(new PointLight(new Color(BLUE), new Point(75,37,0)).setkL(0.001).setkQ(0.0002));
        scene2.lights.add(new SpotLight(new Color(ORANGE), new Point(-30,-82,-10), new Vector(0,0,-1))
                .setkL(0.001).setkQ(0.0001));

        camera2.setImageWriter(new ImageWriter("trianglesAllLights", 500, 500))
                .build()
                .renderImage()
                .writeToImage();
    }
